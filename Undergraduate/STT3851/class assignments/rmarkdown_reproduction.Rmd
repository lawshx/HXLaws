...
This document uses `DT` by Xie (2015), `ggplot2` by Wickham and Chang (2015), `ISLR` by James et al. (2013), `plotly` by Sievert et al. (2015), `rmarkdown` by Allaire et al. (2016), and `knitr` by Xie (2016).
...
Sievert, Carson, Chris Parmer, Toby Hocking, Scott Chamberlain, Karthik Ram, Marianne Corvellec, and Pedro Despouy. 2015. *Plotly: Create Interactive Web Graphics via Plotly’s JavaScript Graphing Library*. [http://CRAN.R-project.org/package=plotly](http://CRAN.R-project.org/package=plotly).
